...
static void torture_callbacks_execute_list(void **state){
    ...
    ssh_callbacks_execute_list(list, ssh_channel_callbacks, channel_eof_function, NULL, NULL);
    ...
    ssh_callbacks_execute_list(list, ssh_channel_callbacks, channel_eof_function, NULL, NULL);
    assert_int_equal(v, 1);
    ssh_callbacks_execute_list(list, ssh_channel_callbacks, channel_exit_status_function, NULL, NULL, 0);
